...
export const TOGGLE_FIELDS = [
        ['progression','setup.progression'],['cancelCorrection','setup.cancelCorrection'],['targetingGrace','setup.targetingGrace'],['timeCancelFatigue','setup.timeCancelFatigue'],['fatigue','setup.fatigue'],['noSameHole','setup.noSameHole'],['attackIncrease','setup.attackIncrease'],['receiveIncrease','setup.receiveIncrease'],['lockDecrease','setup.lockDecrease']
      ] as const;
export const NUMERIC_FIELDS = [
          ['altitude','setup.altitude',0,100000,0.1],['senderAltitude','setup.senderAltitude',0,100000,0.1],
          ['absoluteCap','setup.absoluteCap',0,10000,1],['are','setup.are',0,300,1],['lineClearAre','setup.lineClearAre',0,300,1],
